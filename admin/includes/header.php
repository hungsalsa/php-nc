...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Xin chào:&nbsp;quan trị viên <b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li>
                    <a href="edit_user.php?id=1"><i class="fa fa-fw fa-user"></i> Profile</a>
                </li>                        
                <li>
